...
class Query:
    ...
    def create_connection():
        ...
        try:
            ...
            # connection_string = MySQLdb.connect(host = '127.0.0.1', port = 3306, user = 'root', passwd = '', db = 'ble_school_security')dmabdcom_school_security
            connection_string = MySQLdb.connect(host = '127.0.0.1', port = 3306, user = 'root', passwd = '', db = 'dmabdcom_school_security')
