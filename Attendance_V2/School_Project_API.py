...
def bullying_history():
    ...
    update_notification_querry = "UPDATE `tbl_notification_status_check` SET `status`=0 WHERE `status_type` =%s"
    cursor2.execute(update_notification_querry,("bully"))
    conn.commit()
    cursor2.close()
    ...
    response= {"bullying notification" : rows_total}
